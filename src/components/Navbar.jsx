    ...
    <>
      <div className='mx-auto max-w-7xl font-roboto-slab'>
        <div className='flex justify-between flex-row w-full z-10 px-5 py-5 md:px-10 bg-white'>
          ...
          <ul className={`flex sm:flex gap-8 justify-between flex-col sm:flex-row mt-14 pb-5 sm:pb-0 sm:mt-0 w-full sm:w-auto absolute left-0 pl-5 sm:pl-0 sm:relative bg-white shadow-lg sm:shadow-none ${isOn ? '' : 'hidden'}`}>
            {navItems.map((item) =>  (
